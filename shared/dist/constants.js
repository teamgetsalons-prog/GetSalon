...
export const SITE_FAQS = [
    {
        ...
        answer: "Yes! Booking appointments through GetSalons is completely free for customers. You only pay the salon for the services you receive.",
    },
    {
        question: "How do I cancel or reschedule my appointment?",
        answer: "Go to your dashboard, open the booking and choose Cancel or Reschedule. Please respect each salon's cancellation policy — most require at least 2 hours notice.",
    },
    {
        question: "Are the reviews on GetSalons genuine?",
        answer: "Every review on GetSalons is a verified review — only customers who completed a booking through the platform can rate and review that salon.",
    },
    {
        question: "How do I list my salon on GetSalons?",
        answer: "Click 'Become a Partner', create an owner account and submit your salon profile. Our team reviews and approves new salons within 24–48 hours.",
    },
    {
        question: "Which cities does GetSalons cover?",
        answer: "We are live in Lahore, Karachi, Islamabad, Rawalpindi, Faisalabad and Multan — with more cities being added every month.",
    },
    {
