import type { BookingStatus, UserRole } from "@getsalons/shared/types";

export const SITE = {
  name: "GetSalons Pakistan",
  shortName: "GetSalons",
...
/** Slot granularity for the booking calendar (minutes) */
export const SLOT_INTERVAL = 30;

/** How far ahead customers can book (days) */
export const MAX_BOOKING_DAYS_AHEAD = 30;

/** Minimum minutes before slot start that booking is allowed */
